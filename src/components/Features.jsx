...
const Features = () => {
  return (
    <section className='bg-black pb-12'>
        <div className='contaier mx-auto px-3 md:px-10'>
            ...
            <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates sit aliquam a ipsam optio sunt suscipit ea maiores blanditiis deleniti?
            </p>
            </div>
